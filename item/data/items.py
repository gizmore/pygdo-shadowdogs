...
class items:
    ...
    ITEMS = {
        ...
        'Rusty Pistol': {'klass': 'Firearm', 'level': 1, 'at': 50, 'et': 15, 'rng': 10, 'weight': 800, 'attack': 5, 'defense': 0, 'min_dmg': 8, 'max_dmg': 12, 'eur': 100, 'ammo': '9mm', 'mag_size': 8},
        '9mm Pistol': {'klass': 'Firearm', 'level': 2, 'at': 49, 'et': 16, 'rng': 10, 'weight': 1786, 'attack': 6, 'defense': 0, 'min_dmg': 10, 'max_dmg': 14, 'eur': 34310, 'ammo': '9mm', 'mag_size': 12},
        'Silenced Pistol': {'klass': 'Firearm', 'level': 3, 'at': 48, 'et': 18, 'rng': 10, 'weight': 2771, 'attack': 7, 'defense': 1, 'min_dmg': 12, 'max_dmg': 16, 'eur': 68521, 'ammo': '9mm', 'mag_size': 12},
        'Revolver': {'klass': 'Firearm', 'level': 4, 'at': 47, 'et': 19, 'rng': 10, 'weight': 3757, 'attack': 7, 'defense': 1, 'min_dmg': 15, 'max_dmg': 20, 'eur': 102731, 'ammo': '45ACP', 'mag_size': 6},
        'Compact SMG': {'klass': 'Firearm', 'level': 5, 'at': 46, 'et': 21, 'rng': 10, 'weight': 4743, 'attack': 8, 'defense': 1, 'min_dmg': 18, 'max_dmg': 24, 'eur': 136041, 'ammo': '9mm', 'mag_size': 20},
        'SMG': {'klass': 'Firearm', 'level': 6, 'at': 45, 'et': 22, 'rng': 10, 'weight': 5729, 'attack': 9, 'defense': 2, 'min_dmg': 20, 'max_dmg': 28, 'eur': 169352, 'ammo': '9mm', 'mag_size': 30},
        'Tactical SMG': {'klass': 'Firearm', 'level': 7, 'at': 44, 'et': 24, 'rng': 10, 'weight': 6714, 'attack': 10, 'defense': 2, 'min_dmg': 24, 'max_dmg': 34, 'eur': 202662, 'ammo': '9mm', 'mag_size': 40},
        'Shotgun': {'klass': 'Firearm', 'level': 8, 'at': 43, 'et': 26, 'rng': 10, 'weight': 7700, 'attack': 11, 'defense': 2, 'min_dmg': 28, 'max_dmg': 40, 'eur': 235973, 'ammo': '12g', 'mag_size': 5},
        'Auto Shotgun': {'klass': 'Firearm', 'level': 9, 'at': 42, 'et': 28, 'rng': 10, 'weight': 8686, 'attack': 12, 'defense': 2, 'min_dmg': 32, 'max_dmg': 50, 'eur': 269283, 'ammo': '12g', 'mag_size': 8},
        'Hunting Rifle': {'klass': 'Firearm', 'level': 10, 'at': 41, 'et': 30, 'rng': 30, 'weight': 9671, 'attack': 13, 'defense': 3, 'min_dmg': 36, 'max_dmg': 55, 'eur': 302593, 'ammo': '7.62mm', 'mag_size': 5},
        'Assault Rifle': {'klass': 'Firearm', 'level': 11, 'at': 40, 'et': 32, 'rng': 30, 'weight': 10657, 'attack': 14, 'defense': 3, 'min_dmg': 40, 'max_dmg': 60, 'eur': 335904, 'ammo': '5.56mm', 'mag_size': 30},
        'Carbine': {'klass': 'Firearm', 'level': 12, 'at': 39, 'et': 34, 'rng': 30, 'weight': 11643, 'attack': 15, 'defense': 4, 'min_dmg': 44, 'max_dmg': 65, 'eur': 369214, 'ammo': '5.56mm', 'mag_size': 30},
        'Sniper Rifle': {'klass': 'Firearm', 'level': 13, 'at': 38, 'et': 36, 'rng': 30, 'weight': 12629, 'attack': 16, 'defense': 4, 'min_dmg': 50, 'max_dmg': 80, 'eur': 402525, 'ammo': '7.62mm', 'mag_size': 5},
        'Battle Rifle': {'klass': 'Firearm', 'level': 14, 'at': 37, 'et': 38, 'rng': 30, 'weight': 13614, 'attack': 17, 'defense': 4, 'min_dmg': 55, 'max_dmg': 90, 'eur': 435835, 'ammo': '7.62mm', 'mag_size': 20},
        'LMG': {'klass': 'Firearm', 'level': 15, 'at': 36, 'et': 40, 'rng': 30, 'weight': 14600, 'attack': 18, 'defense': 5, 'min_dmg': 60, 'max_dmg': 95, 'eur': 469145, 'ammo': '7.62mm', 'mag_size': 50},
        'Heavy LMG': {'klass': 'Firearm', 'level': 16, 'at': 35, 'et': 42, 'rng': 30, 'weight': 15586, 'attack': 20, 'defense': 5, 'min_dmg': 70, 'max_dmg': 110, 'eur': 502456, 'ammo': '7.62mm', 'mag_size': 75},
        'Minigun': {'klass': 'Firearm', 'level': 17, 'at': 34, 'et': 45, 'rng': 30, 'weight': 16571, 'attack': 21, 'defense': 6, 'min_dmg': 80, 'max_dmg': 120, 'eur': 535766, 'ammo': '7.62mm', 'mag_size': 200},
        'Grenade Launcher': {'klass': 'Firearm', 'level': 18, 'at': 33, 'et': 48, 'rng': 30, 'weight': 17557, 'attack': 22, 'defense': 6, 'min_dmg': 100, 'max_dmg': 150, 'eur': 569077, 'ammo': '40mm', 'mag_size': 1},
        'Rocket Launcher': {'klass': 'Firearm', 'level': 19, 'at': 32, 'et': 50, 'rng': 30, 'weight': 18543, 'attack': 23, 'defense': 6, 'min_dmg': 120, 'max_dmg': 180, 'eur': 602387, 'ammo': 'RPG', 'mag_size': 1},
        'Railgun': {'klass': 'Firearm', 'level': 20, 'at': 31, 'et': 52, 'rng': 30, 'weight': 19529, 'attack': 24, 'defense': 6, 'min_dmg': 140, 'max_dmg': 200, 'eur': 635697, 'ammo': 'RailSlug', 'mag_size': 5},
        'Laser Pistol': {'klass': 'Firearm', 'level': 21, 'at': 30, 'et': 30, 'rng': 30, 'weight': 20514, 'attack': 25, 'defense': 7, 'min_dmg': 50, 'max_dmg': 80, 'eur': 669008, 'ammo': 'EnergyCell', 'mag_size': 20},
        'Laser Rifle': {'klass': 'Firearm', 'level': 22, 'at': 30, 'et': 35, 'rng': 30, 'weight': 21500, 'attack': 26, 'defense': 7, 'min_dmg': 80, 'max_dmg': 120, 'eur': 702318, 'ammo': 'EnergyCell', 'mag_size': 30},
        'Plasma Carbine': {'klass': 'Firearm', 'level': 23, 'at': 30, 'et': 38, 'rng': 30, 'weight': 22486, 'attack': 28, 'defense': 8, 'min_dmg': 100, 'max_dmg': 150, 'eur': 735629, 'ammo': 'EnergyCell', 'mag_size': 25},
        'Plasma Rifle': {'klass': 'Firearm', 'level': 24, 'at': 30, 'et': 40, 'rng': 30, 'weight': 23471, 'attack': 29, 'defense': 8, 'min_dmg': 120, 'max_dmg': 180, 'eur': 768939, 'ammo': 'EnergyCell', 'mag_size': 30},
        'Plasma Cannon': {'klass': 'Firearm', 'level': 25, 'at': 30, 'et': 42, 'rng': 30, 'weight': 24457, 'attack': 30, 'defense': 8, 'min_dmg': 140, 'max_dmg': 200, 'eur': 802249, 'ammo': 'EnergyCell', 'mag_size': 10},
        'Gauss Rifle': {'klass': 'Firearm', 'level': 26, 'at': 30, 'et': 45, 'rng': 30, 'weight': 25443, 'attack': 31, 'defense': 8, 'min_dmg': 160, 'max_dmg': 220, 'eur': 835560, 'ammo': 'EnergyCell', 'mag_size': 10},
        'Ion Blaster': {'klass': 'Firearm', 'level': 27, 'at': 30, 'et': 48, 'rng': 30, 'weight': 26429, 'attack': 32, 'defense': 9, 'min_dmg': 180, 'max_dmg': 240, 'eur': 868870, 'ammo': 'EnergyCell', 'mag_size': 20},
        'Photon Sniper': {'klass': 'Firearm', 'level': 28, 'at': 30, 'et': 50, 'rng': 30, 'weight': 27414, 'attack': 33, 'defense': 10, 'min_dmg': 200, 'max_dmg': 250, 'eur': 902181, 'ammo': 'EnergyCell', 'mag_size': 5},
        'Disruptor Cannon': {'klass': 'Firearm', 'level': 29, 'at': 30, 'et': 55, 'rng': 30, 'weight': 28400, 'attack': 34, 'defense': 10, 'min_dmg': 220, 'max_dmg': 250, 'eur': 935491, 'ammo': 'EnergyCell', 'mag_size': 5},
        'Omega Railcannon': {'klass': 'Firearm', 'level': 30, 'at': 30, 'et': 60, 'rng': 30, 'weight': 30000, 'attack': 35, 'defense': 12, 'min_dmg': 250, 'max_dmg': 250, 'eur': 1000000, 'ammo': 'RailSlug', 'mag_size': 1},
