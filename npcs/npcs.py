...
class npcs:
    ...
    NPCS = {
        ...
        'goblin':   {'klass': Mob,     'p_level': 6, 'p_race': 'ork',  'p_max_hp': (5,10), 'eq': ['Shoes', 'Trousers', 'Pullover', 'Bytegun']},
        'ork':      {'klass': HardMob, 'p_level': 8, 'p_race': 'ork', 'p_max_hp': (8,12), 'eq': ['CombatBoots', 'Jeans', 'LeatherVest', 'Sword']},
    }
